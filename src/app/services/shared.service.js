(function () {
    ...
    function SharedService($state) {
        ...
        self.routes = [
            ...
            { id: 4, state: 'news.Sinon-among-50-companies-selected', href: '#/news/Sinon-among-50-companies-selected', name: 'SiNon among 50 companies selected for CED Conference', active: false, childContents: [], updatedDate:'2017-02-25T22:56:21+00:00',imgSrc:"assets/images/2017/Conference.jpg"},
            ];
       return self;
    }
